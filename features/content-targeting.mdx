...
As an example, please see below an evaluation flowchart for a **Segmentation Container** with two children plus an optional **Fallback** plugin.
...
To preview how the page looks for a different audience, use the country picker in the top left of the on-page header. Switching to a different country and US state re-renders the page for that selection, and you can see which plugins are active.
...
| By Region (Country) | ✅ | ✅ (called By Region) |
